          ...
          <div class="card shadow-2-strong" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">
              ...
              <form action="" method="POST">
                ...
                <div class="login">
                  <button class="btn btn-primary btn-lg btn-block" name="submit" type="submit">Masuk</button><br>
                </div>
              ...
              if (isset($_POST["submit"])) {
                ...
                if ($username != "" && $password != "") {
                  ...
                  $ambil_konselor = mysqli_query($conn, "SELECT * FROM konselor WHERE username = '$username' AND password = '$password'");
